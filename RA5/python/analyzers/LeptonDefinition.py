...
from CMGTools.RA5.analyzers.LeptonJetRecleaner import LeptonJetRecleaner
...
jetVarToStoreDict = {
    ...
    #'id',
    #'puId',
    'btagCSV': lambda x: x.btag('pfCombinedInclusiveSecondaryVertexV2BJetTags'),
    #'btagCMVA',
    #'rawPt',
    #'mcPt',
    'mcFlavour': lambda x: x.partonFlavour(),
    'partonFlavour': lambda x: x.partonFlavour(),
    #'hadronFlavour',
    #'mcMatchId',
    #'corr_JECUp',
    #'corr_JECDown',
...
leptonJetRecleaner2016 = LeptonJetRecleaner(
    ...
    jetVarToStoreDict = jetVarToStoreDict,
    )

LeptonDict = {
        "2016": leptonJetRecleaner2016,
        }
